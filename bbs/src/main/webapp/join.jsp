    ...
    <nav class="nav">
        <div class="container">
            ...
            <div class="login-join">            	
                ...
                <a href="./join.jsp" class="active">회원가입</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <form action="joinAction.jsp" method="post">
                ...
                <div class="user-email">
                    <input type="email" name="userEmail" id="user-email" placeholder="이메일">
                </div>
                <div class="user-phone">
                    <input type="text" name="userPhone" id="user-phone" placeholder="연락처">
                </div>
